...
window.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelectorAll(".game").forEach(card => { if(card.querySelector("h3")?.textContent === "Three-Handed Rook") card.querySelector(".game-art").innerHTML = `<div class="rook-fan"><b class="r"><span>12</span></b><b class="k"><span>R</span></b><b class="y"><span>1</span></b><b class="g"><span>14</span></b><b class="last"><span>14</span></b></div>`; });
});
